          ...
          <div className="flex flex-row justify-between h-full">
            ...
            <div>
              ...
              <div>
                {expandedProject && expandedProject.image &&
                  <div
                    className={`bg-center bg-no-repeat bg-cover rounded-2xl w-[866px] h-[487px] align-middle mt-4 border-8 border-gray-200 shadow hover:scale-105 transition-all transform ease-out duration-200 ml-8`}
                    style={{
            ...
            <div className="flex flex-col">
              ...
              <div className="ml-12">
                ...
                <div className="w-fit h-[382px] bg-main-color rounded-2xl mt-4 mr-6">
